...
class Response
{
    // from: https://github.com/symfony/symfony/blob/7.2/src/Symfony/Component/HttpFoundation/Response.php#L24
    ...
    // from: https://github.com/symfony/symfony/blob/7.2/src/Symfony/Component/HttpFoundation/Response.php#L125
    ...
    public function redirect(string $path, int $status = 301, array $headers = []): Response
    {
